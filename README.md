...
## Installation
All Python packages required for this project are located in the [requirements.txt](https://github.com/haniazam/SF_Crime_Predictions/blob/master/requirements.txt) and can be installed via the command below.
...
**Data Visualizations**
- [visualizations](https://github.com/haniazam/SF_Crime_Predictions/tree/master/visualizations) - folder containing visualizations of the data (barplots, scatterplots, heatmaps, maps, etc.)

**Hyperparameter Tuning Results**
- [cv_results](https://github.com/haniazam/SF_Crime_Predictions/tree/master/cv_results) - folder containing the hyperparameter tuning results (CV scores (mean & standard deviation) and hyperparameters) at each iteration of Bayesian Optimization.
...
Achieved a multi-class log loss of of **2.25674**, which would ideally rank at **#136** (out of 2,335 teams) or at the **top 6%** or **94th percentile** on the public leaderboard. More details can be found in this notebook: [kaggle-sf-crime-prediction.ipynb](https://github.com/haniazam/SF_Crime_Predictions/blob/master/kaggle-sf-crime-prediction.ipynb)

## License

See the [LICENSE](https://github.com/haniazam/SF_Crime_Predictions/blob/master/LICENSE) file for license rights and limitations (MIT).
